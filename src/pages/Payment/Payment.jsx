...
const Payment = () => {
  ...
  const handlePayment = () => {
    ...
    if (amount === "0") {
      return toast.error("Please add at least one item to proceed with the payment.");
    }
      ...
      const clearCart = async () => {
        try {
          ...
          if (
            ...
            return toast.error("You cannot proceed to payment because your cart is empty.");
          }
